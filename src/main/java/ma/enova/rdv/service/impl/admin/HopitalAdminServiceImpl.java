...
import ma.enova.rdv.service.facade.admin.HopitalAdminService;
...
@Service
public class HopitalAdminServiceImpl extends AbstractServiceImpl<Hopital, HopitalDto,HopitalHistory, HopitalCriteria, HopitalHistoryCriteria, HopitalDao,
HopitalHistoryDao, HopitalConverter> implements HopitalAdminService {

    private UniteAdministrativeAdminService uniteAdministrativeService ;
    public HopitalAdminServiceImpl(HopitalDao dao, HopitalHistoryDao historyDao, HopitalConverter converter, UniteAdministrativeAdminService uniteAdministrativesService) {
