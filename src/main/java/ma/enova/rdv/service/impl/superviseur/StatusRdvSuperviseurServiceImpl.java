...
import ma.enova.rdv.service.facade.superviseur.StatusRdvSuperviseurService;
...
@Service
public class StatusRdvSuperviseurServiceImpl extends AbstractServiceImpl<StatusRdv, StatusRdvDto,StatusRdvHistory, StatusRdvCriteria, StatusRdvHistoryCriteria, StatusRdvDao,
StatusRdvHistoryDao, StatusRdvConverter> implements StatusRdvSuperviseurService {

    public StatusRdvSuperviseurServiceImpl(StatusRdvDao dao, StatusRdvHistoryDao historyDao, StatusRdvConverter converter) {
