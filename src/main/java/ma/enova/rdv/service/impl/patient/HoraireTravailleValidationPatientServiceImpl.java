...
import ma.enova.rdv.service.facade.patient.HoraireTravailleValidationPatientService;
...
@Service
public class HoraireTravailleValidationPatientServiceImpl extends AbstractServiceImpl<HoraireTravailleValidation, HoraireTravailleValidationDto,HoraireTravailleValidationHistory, HoraireTravailleValidationCriteria, HoraireTravailleValidationHistoryCriteria, HoraireTravailleValidationDao,
HoraireTravailleValidationHistoryDao, HoraireTravailleValidationConverter> implements HoraireTravailleValidationPatientService {

    public HoraireTravailleValidationPatientServiceImpl(HoraireTravailleValidationDao dao, HoraireTravailleValidationHistoryDao historyDao, HoraireTravailleValidationConverter converter) {
