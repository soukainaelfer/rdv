...
UniteAdministrativeHistoryDao, UniteAdministrativeConverter> implements UniteAdministrativeAdminService {
    ...
    public UniteAdministrativeAdminServiceImpl(UniteAdministrativeDao dao, UniteAdministrativeHistoryDao historyDao, UniteAdministrativeConverter converter, PrestationAdminService prestationsService) {
