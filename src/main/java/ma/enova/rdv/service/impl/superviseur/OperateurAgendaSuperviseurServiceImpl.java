...
@Service
public class OperateurAgendaSuperviseurServiceImpl extends AbstractServiceImpl<OperateurAgenda, OperateurAgendaDto,OperateurAgendaHistory, OperateurAgendaCriteria, OperateurAgendaHistoryCriteria, OperateurAgendaDao,
OperateurAgendaHistoryDao, OperateurAgendaConverter> implements OperateurAgendaSuperviseurService {

    public OperateurAgendaSuperviseurServiceImpl(OperateurAgendaDao dao, OperateurAgendaHistoryDao historyDao, OperateurAgendaConverter converter) {
