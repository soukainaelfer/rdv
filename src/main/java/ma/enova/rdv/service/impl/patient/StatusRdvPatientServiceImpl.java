...
@Service
public class StatusRdvPatientServiceImpl extends AbstractServiceImpl<StatusRdv, StatusRdvDto,StatusRdvHistory, StatusRdvCriteria, StatusRdvHistoryCriteria, StatusRdvDao,
StatusRdvHistoryDao, StatusRdvConverter> implements StatusRdvPatientService {

    public StatusRdvPatientServiceImpl(StatusRdvDao dao, StatusRdvHistoryDao historyDao, StatusRdvConverter converter) {
