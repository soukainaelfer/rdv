...
import ma.enova.rdv.service.facade.admin.TemplateEmailConfirmationAdminService;
...
@Service
public class TemplateEmailConfirmationAdminServiceImpl extends AbstractServiceImpl<TemplateEmailConfirmation, TemplateEmailConfirmationDto,TemplateEmailConfirmationHistory, TemplateEmailConfirmationCriteria, TemplateEmailConfirmationHistoryCriteria, TemplateEmailConfirmationDao,
TemplateEmailConfirmationHistoryDao, TemplateEmailConfirmationConverter> implements TemplateEmailConfirmationAdminService {

    public TemplateEmailConfirmationAdminServiceImpl(TemplateEmailConfirmationDao dao, TemplateEmailConfirmationHistoryDao historyDao, TemplateEmailConfirmationConverter converter) {
