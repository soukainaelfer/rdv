...
import ma.enova.rdv.service.facade.admin.OperateurAdminService;
...
OperateurHistoryDao, OperateurConverter> implements OperateurAdminService {
    ...
    private OperateurAgendaAdminService operateurAgendaService ;
    private OperateurHoraireTravailleValidationAdminService operateurHoraireTravailleValidationService ;
    private OperateurUniteAdministrativeAdminService operateurUniteAdministrativeService ;
    public OperateurAdminServiceImpl(OperateurDao dao, OperateurHistoryDao historyDao, OperateurConverter converter, OperateurAgendaAdminService operateurAgendasService, OperateurHoraireTravailleValidationAdminService operateurHoraireTravailleValidationsService, OperateurUniteAdministrativeAdminService operateurUniteAdministrativesService) {
