...
@Service
public class HopitalPatientServiceImpl extends AbstractServiceImpl<Hopital, HopitalDto,HopitalHistory, HopitalCriteria, HopitalHistoryCriteria, HopitalDao,
HopitalHistoryDao, HopitalConverter> implements HopitalPatientService {

    private UniteAdministrativePatientService uniteAdministrativeService ;
    public HopitalPatientServiceImpl(HopitalDao dao, HopitalHistoryDao historyDao, HopitalConverter converter, UniteAdministrativePatientService uniteAdministrativesService) {
