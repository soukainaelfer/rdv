...
import ma.enova.rdv.service.facade.patient.OperateurPatientService;
...
@Service
public class OperateurPatientServiceImpl extends AbstractServiceImpl<Operateur, OperateurDto,OperateurHistory, OperateurCriteria, OperateurHistoryCriteria, OperateurDao,
OperateurHistoryDao, OperateurConverter> implements OperateurPatientService {

    private OperateurAgendaPatientService operateurAgendaService ;
    private OperateurHoraireTravailleValidationPatientService operateurHoraireTravailleValidationService ;
    private OperateurUniteAdministrativePatientService operateurUniteAdministrativeService ;
    public OperateurPatientServiceImpl(OperateurDao dao, OperateurHistoryDao historyDao, OperateurConverter converter, OperateurAgendaPatientService operateurAgendasService, OperateurHoraireTravailleValidationPatientService operateurHoraireTravailleValidationsService, OperateurUniteAdministrativePatientService operateurUniteAdministrativesService) {
