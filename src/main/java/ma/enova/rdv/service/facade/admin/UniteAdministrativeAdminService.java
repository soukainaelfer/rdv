...
public interface UniteAdministrativeAdminService extends IService<UniteAdministrative, UniteAdministrativeDto,UniteAdministrativeCriteria, UniteAdministrativeHistoryCriteria> {
