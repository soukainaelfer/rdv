...
@RestController
@RequestMapping("/api/patient/uniteAdministrative")
public class UniteAdministrativeRestPatient  extends AbstractController<UniteAdministrative, UniteAdministrativeDto, UniteAdministrativeHistory, UniteAdministrativeCriteria, UniteAdministrativeHistoryCriteria, UniteAdministrativePatientService, UniteAdministrativeConverter> {
...
//    }
    ...
    public UniteAdministrativeRestPatient (UniteAdministrativePatientService service, UniteAdministrativeConverter converter) {
