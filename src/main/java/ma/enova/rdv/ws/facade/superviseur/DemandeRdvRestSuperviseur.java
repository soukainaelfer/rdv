...
@RestController
@RequestMapping("/api/superviseur/demandeRdv")
public class DemandeRdvRestSuperviseur  extends AbstractController<DemandeRdv, DemandeRdvDto, DemandeRdvHistory, DemandeRdvCriteria, DemandeRdvHistoryCriteria, DemandeRdvSuperviseurService, DemandeRdvConverter> {
...
//    }
    ...
    public DemandeRdvRestSuperviseur (DemandeRdvSuperviseurService service, DemandeRdvConverter converter) {
