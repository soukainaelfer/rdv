...
@RestController
@RequestMapping("/api/admin/demandeRdv")
public class DemandeRdvRestAdmin  extends AbstractController<DemandeRdv, DemandeRdvDto, DemandeRdvHistory, DemandeRdvCriteria, DemandeRdvHistoryCriteria, DemandeRdvAdminService, DemandeRdvConverter> {
...
//    }
    ...
    public DemandeRdvRestAdmin (DemandeRdvAdminService service, DemandeRdvConverter converter) {
