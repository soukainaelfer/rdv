...
import ma.enova.rdv.workflow.demanderdv.save.DemandeRdvSaveInput;
import ma.enova.rdv.workflow.demanderdv.save.DemandeRdvSaveOutput;
...
public class DemandeRdvRestPatient  extends AbstractController<DemandeRdv, DemandeRdvDto, DemandeRdvHistory, DemandeRdvCriteria, DemandeRdvHistoryCriteria, DemandeRdvPatientService, DemandeRdvConverter> {
    ...
    @Autowired
    DemandeRdvSaveProcess demandeRdvSaveProcess;
...
//    }
    ...
    @PostMapping("")
    public Result<DemandeRdvSaveInput,DemandeRdvSaveOutput> create(@RequestBody DemandeRdvDto dto) throws Exception {
        DemandeRdvSaveInput demandeRdvSaveInput= new DemandeRdvSaveInput();
        DemandeRdvSaveOutput demandeRdvSaveOutput= new DemandeRdvSaveOutput();
        BeanUtils.copyProperties(dto,demandeRdvSaveInput);
        return demandeRdvSaveProcess.execute(demandeRdvSaveInput,demandeRdvSaveOutput);
    }
