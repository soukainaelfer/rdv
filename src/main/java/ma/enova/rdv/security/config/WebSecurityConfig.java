package ma.enova.rdv.security.config;
...
import ma.enova.rdv.security.jwt.JWTAuthenticationFilter;
import ma.enova.rdv.security.jwt.JWTAuthorizationFiler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/superviseur/").permitAll();//hasAnyAuthority(AuthoritiesConstants.SUPERVISEUR);
            http.authorizeRequests().antMatchers("/api/patient/").permitAll();//hasAnyAuthority(AuthoritiesConstants.PATIENT);
